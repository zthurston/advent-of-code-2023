...
for (int i = 0; i < allLines.Length; i++)
{
    ...
    for (int j = 0; j < current.Length; j++)
    {
        ...
        // probably could use Span<char> here to avoid allocations
        string currentSlice = current.Substring(j - 1, 3);
...
void ProcessForMatches(string slice, string line, int lineNumber, int symbolIndex)
{
